...
public class XmlContainerElement extends XmlElement
{
   ...
   /**
    *  XmlContainerElement()
    *  This is the basic constructor for XmlContainerElement. It does nothing and
    *  exists only to satisfy the needs of the child object XmlRootElement.
    */
   ...
   /**
    *  XmlContainerElement( String name,
    *			    String attributeName,
    *		            String attributeValue)
    *  This is the primary constructor for XmlContainerElement. The constructor sets
    *  up the value and container element BasicArray objects, and the name of the
    *  root element.
    */
	...
	XmlAttribute identifier = new XmlAttribute(attributeName, attributeValue);
	attributes.objects[IDENTIFIER] = identifier;
    } // end constructor
    ...
    */
    ...
    /**
     *  getIdentifierName()
     *      Return the name of the uniquely defining attribute.
     *  #returns:   String
     */

    public String getIdentifierName()
    {
	XmlAttribute identifier = (XmlAttribute)attributes.objects[IDENTIFIER];
	return identifier.getName();
    } // end function getIdentifierName()

    /**
     *  getIdentifierValue()
     *      Return the value of the uniquely defining attribute.
     *  #returns:   String
     */
    ...
    } // end function getIdentifierValue()
